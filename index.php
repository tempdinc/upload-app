			...
			<div class="col-12 col-lg-6">
				<div class="mb-50 mt-80 text-center">
					<svg width="176" height="50" viewBox="0 0 176 50" fill="none" xmlns="http://www.w3.org/2000/svg">
						<g clip-path="url(#clip0_3_24)">
							...
							<path d="M19.7909 32.6953C20.0806 32.6967 20.3655 32.6215 20.6166 32.4773V38.7856H18.97V32.4821C19.2206 32.6226 19.5034 32.696 19.7909 32.6953Z" fill="#172B41" />
							<path d="M38.9729 10.2987V21.6607H31.134V30.9894H29.4855V20.0187H37.3291V11.9408H12.7731V20.0187H20.6167V29.4959C20.3655 29.352 20.0806 29.2771 19.791 29.2788C19.5034 29.2776 19.2205 29.3511 18.9701 29.4921V21.6607H11.1255V10.2987H38.9729Z" fill="#172B41" />
							<path d="M20.6805 30.9885C20.6813 31.1011 20.6596 31.2128 20.6165 31.3169C20.5507 31.481 20.437 31.6216 20.2903 31.7207C20.1436 31.8197 19.9704 31.8727 19.7932 31.8727C19.616 31.8727 19.4428 31.8197 19.2961 31.7207C19.1494 31.6216 19.0357 31.481 18.9699 31.3169C18.9235 31.2137 18.9001 31.1016 18.9012 30.9885C18.9016 30.8743 18.925 30.7613 18.9699 30.6563C19.0353 30.4924 19.1485 30.3519 19.2948 30.253C19.4412 30.1541 19.614 30.1012 19.7908 30.1013C19.9681 30.1018 20.1412 30.1548 20.2883 30.2536C20.4353 30.3524 20.5495 30.4926 20.6165 30.6563C20.6599 30.7616 20.6817 30.8746 20.6805 30.9885Z" fill="#172B41" />
							<path d="M77.5428 12.4471V14.8774H70.8399V37.9669H68.4029V14.8774H61.7009V12.4471H77.5428Z" fill="#FED925" />
							<path d="M84.4348 14.8774V23.9919H94.1837V26.4221H84.4348V35.5367H96.0117V37.9669H81.9978V12.4471H96.0117V14.8774H84.4348Z" fill="#FED925" />
							<path d="M105.619 19.814L102.725 37.9669H100.212L104.553 11.8398L114.53 33.2578L124.507 11.8398L128.848 37.9669H126.335L123.441 19.814L114.53 38.5742L105.619 19.814Z" fill="#FED925" />
							<path d="M148.765 14.5737C150.389 15.9921 151.202 17.9539 151.202 20.4594C151.202 22.0548 150.865 23.4918 150.193 24.7706C149.529 26.04 148.501 27.0841 147.241 27.77C145.947 28.4916 144.423 28.8524 142.672 28.8524H136.579V37.9669H134.142V12.4471H141.455C144.701 12.4471 147.137 13.156 148.765 14.5737ZM147.07 25.0361C148.2 24.1122 148.765 22.6627 148.765 20.6878C148.765 18.7129 148.168 17.2508 146.975 16.3014C145.782 15.3495 144.284 14.8736 142.482 14.8736H136.579V26.4221H142.672C144.474 26.4221 145.94 25.9601 147.07 25.0361Z" fill="#FED925" />
							<path d="M170.041 14.1368C172.008 15.2638 173.493 16.7891 174.497 18.7126C175.5 20.6361 176.001 22.8011 176 25.2075C176 27.5873 175.486 29.7449 174.458 31.6805C173.431 33.616 171.926 35.1476 169.945 36.2753C167.965 37.4024 165.629 37.9659 162.939 37.9659H155.893V12.4471H162.939C165.705 12.4471 168.072 13.0104 170.041 14.1368ZM168.689 34.2068C170.224 33.3598 171.481 32.0872 172.306 30.5429C173.144 28.9856 173.563 27.2071 173.563 25.2075C173.563 23.2078 173.144 21.429 172.306 19.8711C171.48 18.327 170.224 17.0542 168.689 16.2062C167.114 15.3178 165.273 14.8736 163.167 14.8736H158.33V35.53H163.167C165.273 35.5344 167.114 35.0934 168.689 34.2068Z" fill="#FED925" />
						</g>
						<defs>
				...
				<div id="container" class="qd-none">
					...
					<div class="mb-0 mt-20 z-999 relative">
						<a href="javascript:;" id="uploadfiles" class="btn btn-block btn-yellow fw-600 fs-16 d-none">Upload<span id="upload_quantity"></span></a>
					</div>
					<div class="mb-0 mt-20 z-999 relative">
						<a href="javascript:window.location.href=window.location.href;" id="uploadcancel" class="btn btn-block btn-white fw-600 fs-16 d-none">Cancel</a>
					</div>
				</div>
				<div id="done_container" class="d-none">
					...
					<div class="mb-0 mt-20 z-999 relative">
						<a href="javascript:window.location.href=window.location.href;" id="uploadmore" class="btn btn-block btn-yellow fw-600 fs-16">Upload more photos/video</a>
					</div>
					<div class="mb-0 mt-20 z-999 relative text-center">
						<p>To go Back to Submitting Report, close current tab.</p>
					</div>
					<div class="mb-0 mt-20 z-999 relative d-none">
						<a href="javascript:open(location, '_self').close();" id="back" class="btn btn-block btn-white fw-600 fs-16">Back
